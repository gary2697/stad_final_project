    ...
    public int pingjia3(int[][] mind) {
        ...
        for (int i = 15; i < 20; i++)
            for (int j = 1; j < 5; j++) {
                ...
                for (int k = 0; k < 5; k++) { //same row
                    if (mind[i][j + k] != state_color && mind[i][j + k] != -state_color) space++; //no color
                    if (mind[i][j + k] == state_color) countm++; //my color
                    if (mind[i][j + k] == -state_color) county++; //my opponent color
                }


                if (countm > 0 && county > 0) { // both color detected reset 0
                    mind[i][j] += 0;
                    countm = 0;
                    county = 0;
                    space = 0;
                } else if (space == 5) { // new line
                    mind[i][j] += 7;
                    countm = 0;
                    county = 0;
                    space = 0;
                ...
                for (int k = 0; k < 5; k++) { // same left top to bot right
